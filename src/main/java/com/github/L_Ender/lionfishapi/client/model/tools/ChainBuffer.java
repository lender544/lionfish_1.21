...
public class ChainBuffer {
    ...
    public void applyChainSwingBuffer(ModelPart... boxes) {
        float rotateAmount = 0.01745329251F * ClientUtils.interpolate(this.prevYawVariation, this.yawVariation, Minecraft.getInstance().getTimer().getGameTimeDeltaTicks()) / boxes.length;
    ...
    public void applyChainWaveBuffer(ModelPart... boxes) {
        float rotateAmount = 0.01745329251F * ClientUtils.interpolate(this.prevPitchVariation, this.pitchVariation, Minecraft.getInstance().getTimer().getGameTimeDeltaTicks()) / boxes.length;
        for (ModelPart box : boxes) {
